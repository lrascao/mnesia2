...
init([]) ->
    ...
    MFA = {mnesia2_checkpoint, start, []},
    Modules = [?MODULE, mnesia2_checkpoint, supervisor],
    KillAfter = mnesia2_kernel_sup:supervisor_timeout(timer:seconds(3)),
