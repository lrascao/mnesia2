...
-define(catch_val(Var), (try ?ets_lookup_element(mnesia2_gvar, Var, 2)
...
%% Record for the head structure in Mnesia2's log files
%% 
...
-ifdef(debug).
    -define(eval_debug_fun(I, C),
	    mnesia2_lib:eval_debug_fun(I, C, ?FILE, ?LINE)).
-else.
