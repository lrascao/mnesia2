...
%%
-module(mnesia2_extra_light_SUITE).
...
all() ->
    [{group, extra_light}, clean_up_suite].

groups() ->
    %% The 'extra_light' test suite runs am even smaller
    %% than light selected set of test suites and is
