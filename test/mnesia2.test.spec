{suites,"../test",[mnesia2_SUITE]}.
{skip_cases,"../test",mnesia2_measure_test,
            [ram_meter],
            "Takes to long time"}.
{skip_cases,"../test",mnesia2_measure_test,
            [disc_meter],
...
{skip_cases,"../test",mnesia2_measure_test,
            [disc_only_meter],
            "Takes to long time"}.
{skip_cases,"../test",mnesia2_measure_test,[cost],"Takes to long time"}.
{skip_cases,"../test",mnesia2_measure_test,
            [dbn_meters],
            "Takes to long time"}.
{skip_cases,"../test",mnesia2_measure_test,
...
{skip_cases,"../test",mnesia2_measure_test,
            ...
            "Not yet implemented"}.
{skip_cases,"../test",mnesia2_examples_test,
            [company],
            "Not yet implemented"}.
{skip_cases,"../test",mnesia2_config_test,
            [ignore_fallback_at_startup],
            "Not yet implemented"}.
{skip_cases,"../test",mnesia2_evil_backup,
            [local_backup_checkpoint],
            "Not yet implemented"}.
{skip_cases,"../test",mnesia2_config_test,
            [max_wait_for_decision],
            "Not yet implemented"}.
{skip_cases,"../test",mnesia2_recovery_test,
            [after_full_disc_partition],
            "Not yet implemented"}.
{skip_cases,"../test",mnesia2_recovery_test,
            [system_upgrade],
            "Not yet implemented"}.
{skip_cases,"../test",mnesia2_consistency_test,
...
{skip_cases,"../test",mnesia2_recovery_test,
            ...
            "Failing due to yet unknown reasons"}.
