...
% OLD mnesia2_frag_hash:key_to_frag_number/2.
...
% NEW mnesia2_frag_hash:key_to_frag_number/2.
...
test() ->
    test2(mnesia2_frag_hash:init_state(undefined, undefined)), % phash2
...
test_frag(State) ->
    {State2,_,_} = mnesia2_frag_hash:add_frag(State),
    test_keys(State2),
    State2.
